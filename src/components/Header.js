...
import youTubeMobile from "../assets/youtube-logo.png";
...
const Header = () => {
  ...
  return (
    <div className="flex flex-row h-[80px] px-4 md:px-5 justify-between items-center sticky top-0 z-20 bg-white dark:bg-black shadow-md">
      {loading && <Loader />}
      ...
      <div className="flex h-5 items-center">
        ...
        <Link to="/" className="flex h-36 items-center">
          <img
            src={youTube}
            alt="youTube"
          ...
          <img
            src={youTubeMobile}
            alt="youTube"
            className="h-[80%] w-[100%] md:hidden rounded-full"
          />
        </Link>
      </div>

      <div className="group flex items-center">
        <div className="flex h-8 md:h-12 md:ml-10 md:pl-5 border border-[#404040] rounded-l-3xl group-focus-within:border-blue-500 md:group-focus-within:ml-5 md:group-focus-within:pl-0 ">
        ...
        <button
          ...
          className="w-[40px] md:w-[60px] h-8 md:h-12 flex items-center justify-center border border-l-0 border-[#404040] rounded-r-3xl bg-black/[0.1] dark:bg-white/[0.15]"
        >
